...
Page({
  ...
  onSearchInputType(e) {
    ...
    clearTimeout(this.data.requestInternal)//在下次未调用之前，如果有新的输入，则使用clearTimeout清除上一次的间隔调用。
    ...
    //console.log('d='+this.data.requestInternal) //setTimeout返回一个id标识给clearTimeout用的
  }
})